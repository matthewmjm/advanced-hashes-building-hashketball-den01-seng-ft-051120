...
# :players key points to AOH and each hash should contain the players' stats
 # stat_desc = ["player_name", "number", "shoe", "points", "rebounds", "assists", "steals", "blocks", "slam_dunks"]
  ...
  stat_desc6 = [  (:player_name, “Jeff Adrien”, :number, 4, :shoe, 18, :points, 10, :rebounds, 1, :assists, 1, :steals, 2, :blocks, 7, :slam_dunks, 2)(:player_name, “Bismack Biyombo”, :number, 0, :shoe, 16, :points, 12, :rebounds, 4, :assists, 7, :steals, 22, :blocks, 15, :slam_dunks, 10) ]
  stat_desc7 = [   ]
